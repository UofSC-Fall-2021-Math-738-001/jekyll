...
$$
    \operatorname{Hom}_{\mathcal A}\left( \bigoplus P_i, M) \cong \prod \operatorname{Hom}_{\mathcal A}(P_i, M)
$$
...
$K^\vee = 0$. Since otherwise, there would be an element $k \in K$ and nonzero function $\phi:K \to I$ with $\phi(k)$. Thus
$$
